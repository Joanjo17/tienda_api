...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    // Aunque se llame username, como nosotros le pasamos al Authentication el username y dentro de este
    // también usamos el username, entonces no deberia de haber error
    @Override
