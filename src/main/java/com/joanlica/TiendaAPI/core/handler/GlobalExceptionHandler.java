package com.joanlica.TiendaAPI.core.handler;

import com.joanlica.TiendaAPI.core.exception.*;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleClientNotFoundException(ClientNotFoundException ex, HttpServletRequest req) {
        return errorFactory.entity(HttpStatus.NOT_FOUND, "client-not-found",
                ex.getMessage(), req.getRequestURI(), Map.of());
    }

    @ExceptionHandler(ProductNotFoundException.class)
    public ResponseEntity<Object> handleProductNotFoundException(ProductNotFoundException ex, HttpServletRequest req) {
        return errorFactory.entity(HttpStatus.NOT_FOUND, "product-not-found",
                ex.getMessage(), req.getRequestURI(), Map.of());
    }

    @ExceptionHandler(VentaNotFoundException.class)
    public ResponseEntity<Object> handleVentaNotFoundException(VentaNotFoundException ex, HttpServletRequest req) {
        return errorFactory.entity(HttpStatus.NOT_FOUND, "venta-not-found",
                ex.getMessage(), req.getRequestURI(), Map.of());
    }

    @ExceptionHandler(InsufficientStockException.class)
    public ResponseEntity<Object> handleInsufficientStockException(InsufficientStockException ex, HttpServletRequest req) {
        return errorFactory.entity(HttpStatus.NOT_FOUND, "insufficient-stock",
                ex.getMessage(), req.getRequestURI(), Map.of());
    }

    @ExceptionHandler(ClientAlreadyExistsException.class)
    public ResponseEntity<Object> handleClientAlreadyExistsException(ClientAlreadyExistsException ex, HttpServletRequest req) {
        return errorFactory.entity(HttpStatus.CONFLICT, "client-already-exists",
                ex.getMessage(), req.getRequestURI(), Map.of());
    }
}